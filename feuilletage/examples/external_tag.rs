...
//!
//! Run with: `cargo run -p feuilletage --example external_tag --features json`
...
enum Tool {
    ...
    #[feuilletage(alias = "node")]
    Nodejs(NodejsConfig),
}

#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(array_as = "packages")] // Allows: {"homebrew": ["pkg"]} instead of {"homebrew": {"packages": ["pkg"]}}
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(scalar_as = "version")] // Allows: {"python": "3.11"} instead of {"python": {"version": "3.11"}}
struct PythonConfig {
    /// Python version
    #[feuilletage(default)]
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(scalar_as = "version")] // Allows: {"rust": "1.75"} with name injected from tag
struct MiseConfig {
