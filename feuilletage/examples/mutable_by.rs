...
//!
//! Feuilletage Solution: `#[feuilletage(mutable_by = ["level1", "level2"])]`
//!
//! Example:
//! ```yaml
...
struct SecurityConfig {
    ...
    #[feuilletage(mutable_by = ["system"], default = "false")]
    root_access: bool,

    /// Can be set by system or user level (not workdir)
    #[feuilletage(mutable_by = ["system", "user"], default = "true")]
    auto_update: bool,
...
fn main() {
    ...
    #[derive(Debug, feuilletage::Config, PartialEq)]
    struct PathConfig {
        #[feuilletage(allow_single, mutable_by = ["system", "user"])]
    ...
    struct UpCommandConfig {
        ...
        #[feuilletage(duration, default = "300")]
        timeout: i64,
