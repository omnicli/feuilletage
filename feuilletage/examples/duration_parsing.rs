...
//!
//! Feuilletage Solution: `#[feuilletage(duration)]`
//!
//! Example:
//! ```yaml
...
//!
//! Supported syntax:
//! - `#[feuilletage(duration)]` - Parse to seconds (default)
//! - `#[feuilletage(duration(ns))]` - Parse to nanoseconds
//! - `#[feuilletage(duration(us))]` - Parse to microseconds
//! - `#[feuilletage(duration(ms))]` - Parse to milliseconds
//! - `#[feuilletage(duration(s))]` - Parse to seconds (explicit)
//! - `#[feuilletage(duration(m))]` - Parse to minutes
//! - `#[feuilletage(duration(h))]` - Parse to hours
//! - `#[feuilletage(duration(d))]` - Parse to days
//! - `#[feuilletage(duration(w))]` - Parse to weeks
//!
...
struct MillisConfig {
    ...
    #[feuilletage(duration(ms), default = "100")]
    poll_interval: u64,
}
...
fn main() {
    ...
    struct CacheConfig {
        ...
        #[feuilletage(duration, default = "3600")] // 1 hour default
        ttl: i64,

        #[feuilletage(duration(ms), default = "5000")] // 5 seconds default
        refresh_interval_ms: u64,

        #[feuilletage(duration, default = "86400")] // 1 day default
        max_age: i64,
    }
    ...
    struct JobConfig {
        ...
        #[feuilletage(duration, default = "300")] // 5 minutes default
        timeout: i64,

        #[feuilletage(duration(ms), default = "60000")] // 1 minute default
        retry_delay_ms: u64,

        #[feuilletage(default = "3")]
        max_retries: i32,
    }
