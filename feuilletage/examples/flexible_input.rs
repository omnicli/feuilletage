...
//!
//! Feuilletage Solution: `#[feuilletage(scalar_as = "field", array_as = "field")]`
...
#[feuilletage(scalar_as = "file", array_as = "items")]
struct FlexibleSpec {
    file: Option<String>,
    #[feuilletage(default)]
    items: Vec<String>,
...
fn main() {
    ...
    let serialized = feuilletage::to_json_compact(&spec).unwrap();
    println!("Input: {}", json);
