...
fn warn_selected_alternative<S: feuilletage::CustomSource, L: feuilletage::CustomLevel>(
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(post_process = "warn_selected_alternative")]
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(tag = "type", rename_all = "kebab-case")]
enum KebabCaseEnum {
    FirstVariant,
    SecondOne,
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(tag = "kind", rename_all = "camelCase")]
enum CamelCaseEnum {
    FirstVariant,
    SecondOne,
    MyThirdOption,
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(tag = "type", rename_all = "PascalCase")]
enum PascalCaseEnum {
    FirstVariant,
    SecondOne,
}
...
#[derive(Debug, feuilletage::Config, PartialEq)]
#[feuilletage(tag = "type", rename_all = "SCREAMING_SNAKE_CASE")]
...
enum RenameOverrideEnum {
    FirstVariant,
    #[feuilletage(rename = "custom_name")]
    SecondVariant,
    ThirdVariant,
}
...
enum RenameAllWithAliases {
    #[feuilletage(alias = "v1", alias = "variant-one")]
    FirstVariant,
    SecondVariant,
}
...
fn test_rename_all_serialization() {
    ...
    let json = feuilletage::to_json_compact(&kebab).unwrap();
    assert!(
    ...
    let json = feuilletage::to_json_compact(&camel).unwrap();
    assert!(
    ...
    let json = feuilletage::to_json_compact(&pascal).unwrap();
    assert!(
    ...
    let json = feuilletage::to_json_compact(&screaming).unwrap();
    assert!(
...
fn test_rename_override_serialization() {
    ...
    let json = feuilletage::to_json_compact(&variant).unwrap();
    assert!(
...
enum StrictValueMatched {
    #[feuilletage(variant = "on")]
    On,
    #[feuilletage(variant = "off")]
    Off,
}
...
fn test_value_matched_serialization() {
    ...
    let json = feuilletage::to_json_compact(&val).unwrap();
    ...
    let json2 = feuilletage::to_json_compact(&val2).unwrap();
    assert!(
    ...
    let json3 = feuilletage::to_json_compact(&val3).unwrap();
...
fn test_tagged_enum_fallback_tuple_variant_with_tag() {
    ...
    enum SimpleTupleTagged {
        #[feuilletage(rename = "text")]
        Text { content: String },
        #[feuilletage(rename = "number", fallback)]
        Number { content: i64 },
    }
