//! Tests for the struct-level `#[feuilletage(transform = "fn")]` attribute.
//!
...
use feuilletage::{Config, Context, ContextValue, CustomLevel, CustomSource, Error, Level, Source};
...
#[feuilletage(transform = "self::rename_name_to_username")]
struct UserConfig {
    username: String,
    age: Option<i64>,
}
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[feuilletage(transform = "self::wrap_non_object_as_x")]
struct Boxed {
    x: String,
}
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[feuilletage(transform = "self::wrap_unrecognized_as_payload")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[feuilletage(transform = "self::int_to_string", scalar_as = "value")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[feuilletage(transform = "self::always_fail")]
struct AlwaysFails {
    #[allow(dead_code)]
    field: Option<String>,
}
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[feuilletage(transparent, transform = "self::int_to_string")]
