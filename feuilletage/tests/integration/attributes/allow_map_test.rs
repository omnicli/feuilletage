...
struct FeatureConfig {
    #[feuilletage(allow_map(key = "name", scalar_as = "enabled"))]
...
struct DependencyConfig {
    #[feuilletage(allow_map(key = "package", scalar_as = "version"))]
...
struct GithubReleasesExplicitKeyConfig {
    ...
    #[feuilletage(allow_map(key = "repository", scalar_as = "version"))]
    releases: Vec<GithubRelease>,
}
