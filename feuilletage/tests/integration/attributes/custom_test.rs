...
fn test_custom_with_default_uses_default_on_failure() {
    ...
    struct CustomConfig {
        #[feuilletage(validate = "validate_positive", default = "1")]
        positive_num: i32,
    }
...
fn test_custom_required_field_fails_on_validation_error() {
    ...
    struct RequiredCustomConfig {
        ...
        #[feuilletage(validate = "validate_positive")]
        amount: i32,
    }
...
fn test_custom_string_validator() {
    ...
    struct StringValidatorConfig {
        #[feuilletage(validate = "validate_non_empty", default = "default")]
        name: String,
    }
...
fn test_custom_validator_error_message() {
    ...
    struct NoSpacesConfig {
        #[feuilletage(validate = "validate_no_spaces", default = "default")]
        identifier: String,
    }
...
fn test_even_number_validator() {
    #[derive(DeriveConfig, Debug)]
    struct EvenConfig {
        #[feuilletage(validate = "validate_even", default = "0")]
        count: i32,
    }
