...
//!
//! The `#[feuilletage(deprecated)]` and `#[feuilletage(deprecated = "message")]` attributes
...
fn test_deprecated_field_with_message() {
    ...
    struct DeprecatedConfig {
        #[feuilletage(deprecated = "Use new_field instead")]
        old_field: String,
    }
...
fn test_deprecated_field_still_works() {
    ...
    struct DeprecatedWorksConfig {
        #[feuilletage(deprecated = "This field is deprecated but should still work")]
        legacy_field: String,
...
fn test_deprecated_field_required() {
    ...
    struct DeprecatedRequiredConfig {
        #[feuilletage(deprecated = "Still required even though deprecated")]
...
fn test_deprecated_with_default() {
    ...
    struct DeprecatedDefaultConfig {
        #[feuilletage(deprecated = "Use newer_field instead", default = "default_value")]
        older_field: String,
    }
...
fn test_deprecated_with_default_value_provided() {
    #[derive(DeriveConfig, Debug, PartialEq)]
    struct DeprecatedDefaultConfig {
        #[feuilletage(deprecated = "Use newer_field instead", default = "default")]
        older_field: String,
    }
...
fn test_deprecated_int_field() {
    ...
    struct DeprecatedIntConfig {
        #[feuilletage(deprecated = "Use new_count instead")]
        old_count: i32,
    }
...
fn test_deprecated_bool_field() {
    ...
    struct DeprecatedBoolConfig {
        #[feuilletage(deprecated = "Use new_flag instead")]
        old_flag: bool,
    }
...
fn test_deprecated_vec_field() {
    ...
    struct DeprecatedVecConfig {
        #[feuilletage(deprecated = "Use new_tags instead")]
        old_tags: Vec<String>,
    }
...
fn test_deprecated_option_field() {
    ...
    struct DeprecatedOptionConfig {
        #[feuilletage(deprecated = "Use new_optional instead")]
...
fn test_deprecated_with_rename() {
    ...
    struct DeprecatedRenameConfig {
        #[feuilletage(rename = "oldName", deprecated = "Use newName instead")]
        old_name: String,
    }
...
fn test_deprecated_with_aliases() {
    ...
    struct DeprecatedAliasesConfig {
        #[feuilletage(aliases = ["legacy_name", "old_name"], deprecated = "All these names are deprecated")]
        current_name: String,
    }
...
fn test_deprecated_with_transform() {
    ...
    struct DeprecatedTransformConfig {
        #[feuilletage(deprecated = "Use new_name instead", transform = "to_uppercase")]
        old_name: String,
    }
...
fn test_multiple_deprecated_fields() {
    ...
    struct MultiDeprecatedConfig {
        #[feuilletage(deprecated = "Use config_a instead")]
        old_a: String,

        #[feuilletage(deprecated = "Use config_b instead")]
        old_b: i32,
...
fn test_deprecated_field_serializes() {
    ...
    struct DeprecatedSerializeConfig {
        #[feuilletage(deprecated = "Deprecated but still serialized")]
        old_field: String,
    }
