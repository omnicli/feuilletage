...
//!
//! This tests the `#[feuilletage(transform = "fn")]` attribute which applies
...
// ============================================================================
// Custom transform functions (using built-in transforms from feuilletage::transform)
// ============================================================================

// Note: Custom user-defined transform functions are not directly supported
// because transforms must be in the feuilletage::transform module.
...
fn test_transform_uppercase_with_default() {
    ...
    struct UppercaseDefaultConfig {
        #[feuilletage(transform = "to_uppercase", default = "default_value")]
        name: String,
    }
...
fn test_transform_string_to_lowercase() {
    ...
    struct LowercaseConfig {
        #[feuilletage(transform = "to_lowercase")]
        name: String,
    }
...
fn test_transform_with_rename() {
    ...
    struct TransformRenameConfig {
        #[feuilletage(rename = "userName", transform = "to_lowercase")]
        user_name: String,
    }
...
fn test_transform_with_aliases() {
    ...
    struct TransformAliasConfig {
        #[feuilletage(aliases = ["user", "username"], transform = "to_uppercase")]
        user_name: String,
    }
