...
//! - `#[feuilletage(default_fn = "fn_name")]` - calls fn_name() (existing behavior)
//! - `#[feuilletage(default_fn = "fn_name(field1, field2)")]` - calls fn_name(&field1, &field2)
...
struct ExactVersionConfig {
    ...
    #[feuilletage(default_fn = "compute_exact(version)")]
    exact: bool,
}
...
struct MultiParamConfig {
    ...
    #[feuilletage(default_fn = "compute_display_name(first_name, last_name)")]
    display_name: String,
}
...
struct NumericConfig {
    ...
    #[feuilletage(default_fn = "compute_level(min, max)")]
    level: i32,
}
...
struct ChainedDefaultConfig {
    ...
    #[feuilletage(default_fn = "compute_enabled(count)")]
    enabled: bool,
}
...
struct IndependentFallbackDefaultFn {
    ...
    #[feuilletage(fallback = "source", default_fn = "get_default_fallback_value")]
    target: String,

    #[feuilletage(default_fn = "compute_exact(source)")]
    has_source: bool,
}
...
struct MixedDefaultFnConfig {
    #[feuilletage(default_fn = "get_default_count")]
    count: i32,
