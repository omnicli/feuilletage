...
//!
//! Extracted from feuilletage/src/config.rs
...
fn test_edit_first_writeable_existing_file() {
    ...
    let result = feuilletage::edit_first_writeable(&[&file_path], |config| {
...
fn test_edit_first_writeable_no_save() {
    ...
    let result = feuilletage::edit_first_writeable(&[&file_path], |_config| {
        false // Don't save
    })
    .unwrap();
...
fn test_edit_first_writeable_skips_readonly_file() {
    ...
    let result = feuilletage::edit_first_writeable(&[&readonly_file, &writeable_file], |config| {
...
fn test_edit_first_writeable_no_writeable_candidates() {
    ...
    let result =
        feuilletage::edit_first_writeable(&[&readonly_file, &new_file_in_readonly], |_config| true)
            .unwrap();
...
fn test_edit_first_writeable_creates_parent_dirs() {
    ...
    let result = feuilletage::edit_first_writeable(&[&nested_path], |config| {
