...
//! conversion exists.
//!
//! The macro's `#[feuilletage(coerce)]` attribute uses these functions under the
//! hood.
...
///
/// ```
/// use feuilletage::{Context, ContextValue, Source, Level};
/// use feuilletage::coerce::coerce_to_string;
///
...
/// ```
/// use feuilletage::{Context, ContextValue, Source, Level};
/// use feuilletage::coerce::coerce_to_bool;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
/// ```
/// use feuilletage::{Context, ContextValue, Source, Level};
/// use feuilletage::coerce::coerce_to_i64;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
/// ```
/// use feuilletage::{Context, ContextValue, Source, Level};
/// use feuilletage::coerce::coerce_to_u64;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
/// ```
/// use feuilletage::{Context, ContextValue, Source, Level};
/// use feuilletage::coerce::coerce_to_f64;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
// Unit tests have been moved to feuilletage/tests/unit/coerce_test.rs
