...
//!     name: String,
//!
//!     #[feuilletage(duration)]  // Default: seconds
//!     timeout_secs: u64,
//!
//!     #[feuilletage(duration(ms))]  // Specify unit
//!     timeout_ms: u64,
//!
//!     #[feuilletage(duration(ns))]  // Nanoseconds
//!     latency_ns: u64,
//!
//!     #[feuilletage(duration)]  // Float field preserves precision
//!     fractional_secs: f64,
//! }
//!
...
/// use feuilletage::transform::{trim, TransformRegistry};
///
/// let context = Context::new(Source::Programmatic, Level::User);
/// let mut value = ContextValue::string("  feuilletage  ", context.clone());
...
///
/// assert_eq!(value.as_str(), Some("feuilletage"));
/// ```
...
/// use feuilletage::transform::expand_env_vars;
///
...
/// ```
/// use feuilletage::{ContextValue, Context, Level, Source};
/// use feuilletage::transform::to_uppercase;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
/// ```
/// use feuilletage::{ContextValue, Context, Level, Source};
/// use feuilletage::transform::to_lowercase;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
/// let mut value = ContextValue::string("HELLO WORLD", ctx.clone());
///
...
/// ```
/// use feuilletage::{ContextValue, Context, Level, Source};
/// use feuilletage::transform::trim;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
/// let mut value = ContextValue::string("  hello world  ", ctx.clone());
///
...
/// use feuilletage::{ContextValue, Context, Level, Source};
/// use feuilletage::transform::relative_path;
///
...
///
/// ```
/// use feuilletage::{Config, Context, Level, Source, ContextValue};
...
///
/// ```
/// use feuilletage::transform::unit_to_nanos;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_to_nanos;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_to_secs_u64;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_to_secs_f64;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_to_ms_u64;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_to_ms_f64;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_to_secs;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_u64;
///
...
///
/// ```
/// use feuilletage::transform::parse_duration_f64;
///
...
///
/// This is the transform function used by the `#[feuilletage(duration)]` attribute.
...
/// ```
/// use feuilletage::{ContextValue, Context, Level, Source};
/// use feuilletage::transform::parse_duration;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
///
/// This is the transform function used by the `#[feuilletage(duration_ms)]` attribute.
...
/// ```
/// use feuilletage::{ContextValue, Context, Level, Source};
/// use feuilletage::transform::parse_duration_ms;
///
/// let ctx = Context::new(Source::Programmatic, Level::User);
...
// Unit tests have been moved to feuilletage/tests/unit/transform_test.rs
