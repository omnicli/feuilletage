...
/// the feuilletage library. It produces human-readable, indented JSON output.
///
...
/// ```
/// use serde::Serialize;
/// use feuilletage::to_json_compact;
///
/// #[derive(Serialize)]
/// struct Config {
///     host: String,
...
/// the feuilletage library. It produces pretty-printed TOML output.
///
/// # Arguments
///
/// * `value` - Any type that implements `serde::Serialize`
...
/// ```
/// use serde::Serialize;
/// use feuilletage::{to_format, Format};
///
/// #[derive(Serialize)]
/// struct Config {
///     host: String,
...
// Unit tests have been moved to feuilletage/tests/unit/ser_test.rs
