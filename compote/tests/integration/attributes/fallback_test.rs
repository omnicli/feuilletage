...
struct FallbackWithDefault {
    ...
    #[compote(fallback = "name", default = "unnamed")]
    display_name: String,
}
...
struct BidirectionalFallback {
    ...
    #[compote(fallback = "id", default = "default_value")]
    choice: String,
}
...
struct ChainFallback {
    #[compote(fallback = "secondary")]
    primary: String,

    #[compote(fallback = "tertiary")]
    secondary: String,

    #[compote(default = "chain_default")]
    tertiary: String,
}
...
struct RenamedFallback {
    ...
    #[compote(fallback = "user_name", rename = "displayName")]
    display_name: String,
}
