...
struct SkipIfCustomString {
    #[compote(skip_if = "is_empty_string", default = "")]
...
struct SkipIfCustomInt {
    #[compote(skip_if = "is_zero", default = "0")]
    count: i32,
}
...
impl compote::IsEmpty for InnerWithVec {
...
impl compote::IsEmpty for InnerWithOption {
    fn is_empty(&self) -> bool {
        self.value.is_none()
    }
}
...
struct CombinedSkipConfig {
    ...
    #[compote(skip_if_default, default = "default_value")]
...
#[derive(Debug, compote::Config, PartialEq)]
#[compote(tag = "type", skip_serialize)]
enum SkipSerializeTaggedEnum {
    #[compote(rename = "alpha")]
    Alpha { value: String },
    #[compote(rename = "beta")]
    Beta { count: i32 },
}
