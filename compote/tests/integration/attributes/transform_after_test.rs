...
use compote::{Context, Error, Level, Source};
...
fn test_transform_after_basic_string() {
    ...
    struct Config {
        #[compote(transform_after = "uppercase_string")]
        name: String,
    }
...
fn test_transform_after_trim_string() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "trim_string")]
        value: String,
    }
...
fn test_transform_after_integer() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "double_int")]
        count: i32,
    }
...
fn test_transform_after_bool() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "negate_bool")]
        flag: bool,
    }
...
fn test_transform_after_with_default_missing_field() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "uppercase_string", default = "default_value")]
        name: String,
    }
...
fn test_transform_after_error_fails_deserialization() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "reject_empty")]
        name: String,
    }
...
fn test_transform_after_error_with_default_fallback() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "reject_empty", default = "fallback")]
        name: String,
    }
...
fn test_transform_after_with_transform() {
    ...
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform = "trim", transform_after = "uppercase_string")]
        name: String,
    }
...
fn test_transform_after_with_validation() {
    ...
    struct Config {
        ...
        #[compote(transform_after = "add_prefix", validate = "validate_length")]
        name: String,
    }
...
fn test_transform_after_with_coerce() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(coerce, transform_after = "double_int")]
        count: i32,
    }
...
fn test_transform_each_after_basic() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(allow_single, transform_each_after = "uppercase_string")]
        items: Vec<String>,
    }
...
fn test_transform_each_after_integers() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(allow_single, transform_each_after = "double_int")]
        numbers: Vec<i32>,
    }
...
fn test_transform_each_after_error_skips_element() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(allow_single, transform_each_after = "reject_empty")]
        items: Vec<String>,
    }
...
fn test_transform_each_after_error_on_error_fail() {
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(allow_single, transform_each_after = "reject_empty", on_error = "fail")]
        items: Vec<String>,
    }
...
fn test_transform_after_option_some() {
    ...
    #[derive(DeriveConfig, Debug)]
    struct Config {
        #[compote(transform_after = "uppercase_option")]
        name: Option<String>,
    }
