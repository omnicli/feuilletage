...
#[derive(Debug, compote::Config, PartialEq)]
#[compote(external_tag, rename_all = "lowercase")]
enum LowercaseEnum {
...
#[derive(Debug, compote::Config, PartialEq)]
#[compote(external_tag, rename_all = "UPPERCASE")]
enum UppercaseEnum {
    FirstVariant(SimpleConfig),
    SecondVariant(SimpleConfig),
    MyLongVariantName(SimpleConfig),
...
#[derive(Debug, compote::Config, PartialEq)]
#[compote(external_tag, rename_all = "camelCase")]
enum CamelCaseEnum {
    FirstVariant(SimpleConfig),
    SecondVariant(SimpleConfig),
    MyLongVariantName(SimpleConfig),
...
#[derive(Debug, compote::Config, PartialEq)]
#[compote(external_tag, rename_all = "PascalCase")]
enum PascalCaseEnum {
    FirstVariant(SimpleConfig),
    SecondVariant(SimpleConfig),
    MyLongVariantName(SimpleConfig),
...
#[derive(Debug, compote::Config, PartialEq)]
#[compote(external_tag, rename_all = "SCREAMING_SNAKE_CASE")]
