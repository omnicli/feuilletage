...
//!
//! The `#[compote(template)]` attribute enables template interpolation using
//! `%{field}` syntax to reference other fields in the same struct.
//!
//! Unit tests for the template module are in compote/tests/unit/template_test.rs.
...
fn test_template_with_multiple_refs() {
    ...
    struct MultiRefsConfig {
        ...
        #[compote(template(refs = ["first_name", "last_name"]))]
        full_name: String,
    }
...
fn test_template_with_default() {
    ...
    struct DefaultTemplateConfig {
        ...
        #[compote(template, default = "http://%{host}/default")]
        url: String,
    }
...
fn test_template_uses_default_when_missing() {
    ...
    struct DefaultMissingConfig {
        ...
        #[compote(template, default = "default_url")]
        url: String,
    }
...
fn test_template_with_rename() {
    ...
    struct RenameTemplateConfig {
        ...
        #[compote(rename = "apiUrl", template)]
        api_url: String,
    }
