...
//!
//! This file tests `#[compote(duration)]` with various unit configurations.
...
fn test_duration_ms_parsing_error_uses_default() {
    #[derive(DeriveConfig, Debug)]
    struct DurationMsConfig {
        #[compote(duration(ms), default = "1000")]
        timeout: u64,
    }
...
fn test_duration_and_duration_ms_combined() {
    ...
    struct MixedDurationConfig {
        ...
        #[compote(duration(ms), default = "500")]
...
fn test_duration_f32() {
    ...
    struct DurationF32Config {
        #[compote(duration(ms), default = "0.0")]
        timeout: f32,
    }
...
fn test_duration_explicit_syntax_ms() {
    ...
    struct DurationExplicitConfig {
        #[compote(duration(unit = ms), default = "0")]
        timeout_ms: u64,
    }
...
fn test_duration_explicit_syntax_all_units() {
    ...
    struct AllUnitsExplicitConfig {
        #[compote(duration(unit = ns), default = "0")]
        nanos: u64,

        #[compote(duration(unit = us), default = "0")]
        micros: u64,

        #[compote(duration(unit = ms), default = "0")]
        millis: u64,

        #[compote(duration(unit = s), default = "0")]
        secs: u64,

        #[compote(duration(unit = m), default = "0")]
        mins: u64,

        #[compote(duration(unit = h), default = "0")]
        hours: u64,

        #[compote(duration(unit = d), default = "0")]
        days: u64,

        #[compote(duration(unit = w), default = "0")]
        weeks: u64,
    }
...
fn test_duration_explicit_syntax_float() {
    ...
    struct FloatExplicitConfig {
        #[compote(duration(unit = s), default = "0.0")]
        timeout: f64,
    }
