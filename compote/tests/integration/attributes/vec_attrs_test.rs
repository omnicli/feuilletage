...
fn deserialize_json<T: compote::FromContextValue>(json: &str) -> Result<T, compote::Error> {
...
fn test_vec_allow_single_with_explicit_default() {
    ...
    struct TestConfig {
        #[compote(allow_single, default = "vec![\"default\".to_string()]")]
        items: Vec<String>,
    }
...
fn test_vec_allow_map_with_default() {
    ...
    struct TestConfig {
        #[compote(allow_map = "id", default = "Vec::new()")]
        entries: Vec<Entry>,
    }
...
fn test_vec_allow_single_with_mutable_by_allowed() {
    #[derive(Debug, DeriveConfig)]
    struct TestConfig {
        #[compote(allow_single, mutable_by = ["user"])]
        items: Vec<String>,
    }
...
fn test_vec_allow_single_with_mutable_by_denied() {
    #[derive(Debug, DeriveConfig)]
    struct TestConfig {
        #[compote(allow_single, mutable_by = ["system"])]
        items: Vec<String>,
    }
...
fn test_vec_allow_map_with_mutable_by_allowed() {
    ...
    #[derive(Debug, DeriveConfig)]
    struct TestConfig {
        #[compote(allow_map = "id", mutable_by = ["local"])]
        entries: Vec<Entry>,
    }
...
fn test_vec_allow_single_with_transform_each_to_lowercase() {
    #[derive(Debug, DeriveConfig, PartialEq)]
    struct TestConfig {
        #[compote(allow_single, transform_each = "to_lowercase")]
        items: Vec<String>,
    }
...
fn test_vec_allow_single_with_alias() {
    #[derive(Debug, DeriveConfig, PartialEq)]
    struct TestConfig {
        #[compote(allow_single, aliases = ["things"])]
        items: Vec<String>,
    }
