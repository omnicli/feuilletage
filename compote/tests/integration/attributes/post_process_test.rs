...
#[compote(post_process = "uppercase_name")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[compote(post_process = "finalize_go_install")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[compote(post_process = "validate_positive")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[compote(post_process = "warn_deprecated_field")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[compote(post_process = "normalize_paths")]
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[compote(post_process = "set_defaults_from_nested")]
struct NestedConfig {
    #[compote(default)]
    name: String,
    inner: InnerConfig,
...
#[derive(Debug, DeriveConfig, PartialEq)]
#[compote(post_process = "dedupe_items")]
struct VecConfig {
    items: Vec<String>,
}
