...
//!
//! The `#[compote(secret)]` attribute marks fields as sensitive, affecting how
...
fn test_secret_field_with_default() {
    ...
    struct SecretDefaultConfig {
        #[compote(secret, default = "default_secret")]
        password: String,
    }
...
fn test_secret_with_regex_validation_failure() {
    ...
    struct SecretRegexConfig {
        #[compote(secret, regex = r"^[a-z]+$", default = "default")]
        token: String,
    }
...
fn test_secret_with_length_validation_failure() {
    ...
    struct SecretLengthConfig {
        #[compote(secret, length(min = 8), default = "12345678")]
        password: String,
    }
...
fn test_secret_with_env() {
    ...
    struct SecretEnvConfig {
        #[compote(env = "TEST_SECRET_API_KEY_12345", secret, default = "fallback")]
        api_key: String,
    }
...
fn test_secret_with_skip_serialization() {
    ...
    struct SecretSkipConfig {
        #[compote(secret, skip, default = "hidden_default")]
        password: String,
