...
//!
//! Compote Solution: `#[compote(relative_path)]` or `#[compote(transform = "relative_path")]`
//!
//! Example:
//! ```yaml
...
fn main() {
    ...
    struct VecPathConfig {
        #[compote(allow_single, transform_each = "relative_path")]
    ...
    struct ProjectConfig {
        ...
        #[compote(relative_path, default = "Makefile")]
        makefile: String,

        #[compote(relative_path, default = "templates")]
        template_dir: String,
