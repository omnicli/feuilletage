...
//!
//! These examples demonstrate the #[compote(template)] attribute for field reference interpolation.
//!
...
fn main() {
    ...
    struct ApiConfig {
        base_url: String,
        api_version: String,
        #[compote(template, default = "%{base_url}/api/v%{api_version}")]
        api_endpoint: String,
    }

    let mut cfg = compote::Config::default();
    cfg.load_json(
        r#"{
    ...
    use compote::extract_field_references;
    ...
    use compote::{value_to_string, ContextValue};
