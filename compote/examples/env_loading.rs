...
struct EnvConfig {
    ...
    #[compote(env = "TEST_API_KEY")]
    api_key: String,

    /// Optional field from env
    #[compote(env = "TEST_SECRET")]
    secret: Option<String>,

    /// Field with fallback default
    #[compote(env = "TEST_TIMEOUT", default = "30")]
    timeout: i32,
}
...
fn main() {
    ...
    struct MultiEnvConfig {
        #[compote(env = "DB_HOST", default = "localhost")]
        db_host: String,

        #[compote(env = "DB_PORT", coerce, default = "5432")]
        db_port: i32,

        #[compote(env = "DB_USER", default = "postgres")]
        db_user: String,

        #[compote(env = "DB_PASSWORD")]
    ...
    #[derive(Debug, compote::Config, PartialEq)]
    struct CloudConfig {
        #[compote(env = "CLOUD_REGION", default = "us-east-1")]
        region: String,

        #[compote(env = "CLOUD_ACCESS_KEY")]
        access_key: Option<String>,

        #[compote(env = "CLOUD_SECRET_KEY", secret)]
        secret_key: Option<String>,

        #[compote(env = "CLOUD_PROFILE", default = "default")]
        profile: String,
    }
