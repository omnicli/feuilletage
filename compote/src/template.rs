...
//!
//! Mark fields with `#[compote(template)]` to enable interpolation:
//!
//! ```
...
///
/// ```
/// use compote::template::TemplateError;
///
/// // Missing field error
...
///
/// ```
/// use compote::template::extract_field_references;
///
/// assert_eq!(
...
///
/// ```
/// use compote::{Context, ContextValue, Level, Source, value_to_string};
///
...
///
/// ```
/// use compote::interpolate_template;
...
// Unit tests have been moved to compote/tests/unit/template_test.rs
