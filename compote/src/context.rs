...
//! ```
//! # #[cfg(feature = "std")] {
//! use compote::{CustomSource, CustomLevel};
...
/// ```
/// # #[cfg(feature = "std")] {
/// use compote::{CustomSource, Context, ContextValue, ErrorTracker, FromContextValue, OrderedMap};
/// use std::path::{Path, PathBuf};
///
...
/// let ctx = Context::<AppSource, compote::Level>::new(
...
///
/// ```
/// use compote::{CustomLevel, Context, ContextValue, ErrorTracker, FromContextValue, OrderedMap, Source};
///
    ...
    Clone + Debug + Default + Send + Sync + PartialEq + Eq + Hash + 'static
{
    ...
    /// use compote::{ConfigLoaderBuilder, ContextValue, CustomLevel, Format, Source};
    ///
    /// #[derive(Clone, Debug, Default, PartialEq, Eq, Hash)]
    /// enum DeployLevel {
    ///     Production,
...
///
/// ```
/// use compote::{Level, MutabilityConstraint};
///
...
/// ```
/// # #[cfg(feature = "std")] {
/// use compote::{Context, Level, Source, Format};
///
...
impl<S: SourceType, L: LevelType> Context<S, L> {
    ...
    ///
    /// ```
    /// use compote::{Context, Level, Source};
    ///
...
// Unit tests have been moved to compote/tests/unit/context_test.rs
